...
enum class Scenario(
    ...
    /**
     * RAG Чат - чат с RAG-памятью и историей диалога.
     * При каждом новом вопросе ищет контекст в базе документов (topK=3),
     * комбинирует с историей диалога (до 10 сообщений) и возвращает ответ со ссылками на источники.
     */
    RAG_CHAT(
        displayName = "💬 RAG Чат",
        command = "rag-chat",
        callbackData = "scenario_rag_chat"
    );
